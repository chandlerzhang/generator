...
public class Dictionary  implements BaseEntity {
    ...
    public Dictionary(Integer code, String name, Long parentId, String status, Long creator, Date created) {
        this.code = code;
        this.name = name;
    ...
    public Dictionary(Integer code, Integer serial, String name, Long parentId, String status, Long creator, Date created, Long modificator, Date modified) {
       this.code = code;
       this.serial = serial;
       this.name = name;
       this.parentId = parentId;
